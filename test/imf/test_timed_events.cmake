...
elseif(TEST_MODE STREQUAL "samples")
    ...
    set(output_file_1 ${BMX_TEST_SAMPLES_DIR}/test_timed_events_1.mxf)
else()
    set(output_file_1 test_1.mxf)
endif()
...
set(create_command ${RAW2BMX}
    ...
    -f 25
    --dur 100
    --timed-events "${TEST_SOURCE_DIR}/../timed_events/manifest_2.xml"
)
...
elseif(TEST_MODE STREQUAL "samples")
    set(output_file ${BMX_TEST_SAMPLES_DIR}/test_timed_events_2.mxf)
else()
    set(output_file test.mxf)
endif()
